...
public class Preferences extends SecureSharedPreferences {
    ...
    /**
     * Set the current default global {@link Preferences} instance and return it.
     * @param preferences the {@link Preferences} instance to be set as default
     * @return the {@link Preferences} which was set (always {@param preferences}).
     */
    public static Preferences setInstance(Preferences preferences){
        INSTANCE = preferences; return INSTANCE;
    }
