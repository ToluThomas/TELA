...
public class Factory {
    ...
    public static class Book {
        ...
        public static List<Book> getBooks(){
            ...
            list.add(new Book(R.drawable.book_bush_house_rat_1, R.drawable.book_bush_house_rat_2, R.drawable.book_bush_house_rat_3, R.drawable.book_bush_house_rat_4,
                    R.drawable.book_bush_house_rat_5, R.drawable.book_bush_house_rat_6, R.drawable.book_bush_house_rat_7, R.drawable.book_bush_house_rat_8, R.drawable.book_bush_house_rat_9,
                     R.drawable.book_bush_house_rat_11, R.drawable.book_bush_house_rat_12, R.drawable.book_bush_house_rat_13, R.drawable.book_bush_house_rat_14, R.drawable.book_bush_house_rat_15,
                    R.drawable.book_bush_house_rat_16, R.drawable.book_bush_house_rat_17, R.drawable.book_bush_house_rat_18, R.drawable.book_bush_house_rat_19, R.drawable.book_bush_house_rat_20,
                    R.drawable.book_bush_house_rat_21, R.drawable.book_bush_house_rat_22, R.drawable.book_bush_house_rat_23, R.drawable.book_bush_house_rat_24, R.drawable.book_bush_house_rat_25,
                    R.drawable.book_bush_house_rat_26, R.drawable.book_bush_house_rat_27).setIconRes(R.drawable.book_bush_house_rat_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_children_wax_2, R.drawable.book_children_wax_3, R.drawable.book_children_wax_4, R.drawable.book_children_wax_5, R.drawable.book_children_wax_6,
                    R.drawable.book_children_wax_7, R.drawable.book_children_wax_8, R.drawable.book_children_wax_9, R.drawable.book_children_wax_10, R.drawable.book_children_wax_11, R.drawable.book_children_wax_12,
                    R.drawable.book_children_wax_13, R.drawable.book_children_wax_14, R.drawable.book_children_wax_15, R.drawable.book_children_wax_16, R.drawable.book_children_wax_17,
                    R.drawable.book_children_wax_18, R.drawable.book_children_wax_19).setIconRes(R.drawable.book_children_wax_icon).setRealSupport(true));
            list.add(new Book(R.drawable.cooking_with_mother_1, R.drawable.cooking_with_mother_2, R.drawable.cooking_with_mother_3, R.drawable.cooking_with_mother_4, R.drawable.cooking_with_mother_5, R.drawable.cooking_with_mother_6,
                    R.drawable.cooking_with_mother_7, R.drawable.cooking_with_mother_8, R.drawable.cooking_with_mother_9, R.drawable.cooking_with_mother_10, R.drawable.cooking_with_mother_11,
                    R.drawable.cooking_with_mother_12, R.drawable.cooking_with_mother_13, R.drawable.cooking_with_mother_14, R.drawable.cooking_with_mother_15, R.drawable.cooking_with_mother_16, R.drawable.cooking_with_mother_17,
                    R.drawable.cooking_with_mother_18, R.drawable.cooking_with_mother_19).setIconRes(R.drawable.book_cooking_mother_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_fatima_count_1, R.drawable.book_fatima_count_2, R.drawable.book_fatima_count_3, R.drawable.book_fatima_count_4, R.drawable.book_fatima_count_5, R.drawable.book_fatima_count_6,
                    R.drawable.book_fatima_count_7, R.drawable.book_fatima_count_8, R.drawable.book_fatima_count_9, R.drawable.book_fatima_count_10, R.drawable.book_fatima_count_11,
                    R.drawable.book_fatima_count_12, R.drawable.book_fatima_count_13, R.drawable.book_fatima_count_14, R.drawable.book_fatima_count_15, R.drawable.book_fatima_count_16, R.drawable.book_fatima_count_17,
                    R.drawable.book_fatima_count_18, R.drawable.book_fatima_count_19, R.drawable.book_fatima_count_20).setIconRes(R.drawable.book_fatima_count_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_going_home_1, R.drawable.book_going_home_2, R.drawable.book_going_home_3, R.drawable.book_going_home_4, R.drawable.book_going_home_5, R.drawable.book_going_home_6, R.drawable.book_going_home_7,
                    R.drawable.book_going_home_8, R.drawable.book_going_home_9, R.drawable.book_going_home_10, R.drawable.book_going_home_11, R.drawable.book_going_home_12, R.drawable.book_going_home_13, R.drawable.book_going_home_14,
                    R.drawable.book_going_home_15, R.drawable.book_going_home_16, R.drawable.book_going_home_17, R.drawable.book_going_home_18, R.drawable.book_going_home_19, R.drawable.book_going_home_20, R.drawable.book_going_home_21,
                    R.drawable.book_going_home_22, R.drawable.book_going_home_23, R.drawable.book_going_home_24, R.drawable.book_going_home_25, R.drawable.book_going_home_26, R.drawable.book_going_home_27).setIconRes(R.drawable.book_going_home_icon)
            .setRealSupport(true));
            list.add(new Book(R.drawable.book_goso_teacher_1, R.drawable.book_goso_teacher_2, R.drawable.book_goso_teacher_3, R.drawable.book_goso_teacher_4, R.drawable.book_goso_teacher_5, R.drawable.book_goso_teacher_6, R.drawable.book_goso_teacher_7,
                    R.drawable.book_goso_teacher_8, R.drawable.book_goso_teacher_9, R.drawable.book_goso_teacher_10, R.drawable.book_goso_teacher_11, R.drawable.book_goso_teacher_12, R.drawable.book_goso_teacher_13,
                    R.drawable.book_goso_teacher_14, R.drawable.book_goso_teacher_15, R.drawable.book_goso_teacher_16, R.drawable.book_goso_teacher_17, R.drawable.book_goso_teacher_18, R.drawable.book_goso_teacher_19,
                    R.drawable.book_goso_teacher_20, R.drawable.book_goso_teacher_21, R.drawable.book_goso_teacher_22, R.drawable.book_goso_teacher_23, R.drawable.book_goso_teacher_24, R.drawable.book_goso_teacher_25, R.drawable.book_goso_teacher_26,
                    R.drawable.book_goso_teacher_27, R.drawable.book_goso_teacher_28, R.drawable.book_goso_teacher_29, R.drawable.book_goso_teacher_30, R.drawable.book_goso_teacher_31,
                    R.drawable.book_goso_teacher_32, R.drawable.book_goso_teacher_33, R.drawable.book_goso_teacher_34).setIconRes(R.drawable.book_goso_teacher_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_hare_and_hyena_1, R.drawable.book_hare_and_hyena_2, R.drawable.book_hare_and_hyena_3, R.drawable.book_hare_and_hyena_4, R.drawable.book_hare_and_hyena_5, R.drawable.book_hare_and_hyena_6, R.drawable.book_hare_and_hyena_7,
                    R.drawable.book_hare_and_hyena_8, R.drawable.book_hare_and_hyena_9, R.drawable.book_hare_and_hyena_10, R.drawable.book_hare_and_hyena_11, R.drawable.book_hare_and_hyena_12, R.drawable.book_hare_and_hyena_13, R.drawable.book_hare_and_hyena_14,
                    R.drawable.book_hare_and_hyena_15, R.drawable.book_hare_and_hyena_16, R.drawable.book_hare_and_hyena_17, R.drawable.book_hare_and_hyena_18, R.drawable.book_hare_and_hyena_19, R.drawable.book_hare_and_hyena_20, R.drawable.book_hare_and_hyena_21,
                    R.drawable.book_hare_and_hyena_22, R.drawable.book_hare_and_hyena_23, R.drawable.book_hare_and_hyena_24).setIconRes(R.drawable.book_hare_hyena_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_little_ant_thank_1, R.drawable.book_little_ant_thank_2, R.drawable.book_little_ant_thank_3, R.drawable.book_little_ant_thank_4, R.drawable.book_little_ant_thank_5, R.drawable.book_little_ant_thank_6, R.drawable.book_little_ant_thank_7,
                    R.drawable.book_little_ant_thank_8, R.drawable.book_little_ant_thank_9, R.drawable.book_little_ant_thank_10, R.drawable.book_little_ant_thank_11, R.drawable.book_little_ant_thank_12, R.drawable.book_little_ant_thank_13, R.drawable.book_little_ant_thank_14,
                    R.drawable.book_little_ant_thank_15, R.drawable.book_little_ant_thank_16, R.drawable.book_little_ant_thank_17, R.drawable.book_little_ant_thank_18, R.drawable.book_little_ant_thank_19, R.drawable.book_little_ant_thank_20, R.drawable.book_little_ant_thank_21,
                    R.drawable.book_little_ant_thank_22, R.drawable.book_little_ant_thank_23, R.drawable.book_little_ant_thank_24, R.drawable.book_little_ant_thank_25, R.drawable.book_little_ant_thank_26, R.drawable.book_little_ant_thank_27, R.drawable.book_little_ant_thank_28,
                    R.drawable.book_little_ant_thank_29, R.drawable.book_little_ant_thank_30, R.drawable.book_little_ant_thank_31, R.drawable.book_little_ant_thank_32, R.drawable.book_little_ant_thank_33, R.drawable.book_little_ant_thank_34)
            .setIconRes(R.drawable.book_how_little_ant_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_i_can_1, R.drawable.book_i_can_2, R.drawable.book_i_can_3, R.drawable.book_i_can_4, R.drawable.book_i_can_5, R.drawable.book_i_can_6, R.drawable.book_i_can_7, R.drawable.book_i_can_8, R.drawable.book_i_can_9, R.drawable.book_i_can_10,
                    R.drawable.book_i_can_11, R.drawable.book_i_can_12, R.drawable.book_i_can_13, R.drawable.book_i_can_14, R.drawable.book_i_can_15, R.drawable.book_i_can_16, R.drawable.book_i_can_17, R.drawable.book_i_can_18, R.drawable.book_i_can_19,
                    R.drawable.book_i_can_20, R.drawable.book_i_can_21, R.drawable.book_i_can_22).setIconRes(R.drawable.book_i_can_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_i_see_tail_1, R.drawable.book_i_see_tail_2, R.drawable.book_i_see_tail_3, R.drawable.book_i_see_tail_4, R.drawable.book_i_see_tail_5, R.drawable.book_i_see_tail_6, R.drawable.book_i_see_tail_7, R.drawable.book_i_see_tail_8, R.drawable.book_i_see_tail_9,
                    R.drawable.book_i_see_tail_10, R.drawable.book_i_see_tail_11, R.drawable.book_i_see_tail_12, R.drawable.book_i_see_tail_13, R.drawable.book_i_see_tail_14, R.drawable.book_i_see_tail_15, R.drawable.book_i_see_tail_16, R.drawable.book_i_see_tail_17, R.drawable.book_i_see_tail_18,
                    R.drawable.book_i_see_tail_19, R.drawable.book_i_see_tail_20, R.drawable.book_i_see_tail_21, R.drawable.book_i_see_tail_22).setIconRes(R.drawable.book_i_see_tail_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_i_enjoy_1, R.drawable.book_i_enjoy_2, R.drawable.book_i_enjoy_3, R.drawable.book_i_enjoy_4, R.drawable.book_i_enjoy_5, R.drawable.book_i_enjoy_6, R.drawable.book_i_enjoy_7, R.drawable.book_i_enjoy_8, R.drawable.book_i_enjoy_9,
                    R.drawable.book_i_enjoy_10, R.drawable.book_i_enjoy_11, R.drawable.book_i_enjoy_12, R.drawable.book_i_enjoy_13, R.drawable.book_i_enjoy_14, R.drawable.book_i_enjoy_15).setIconRes(R.drawable.book_i_enjoy_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_lazy_junio_1, R.drawable.book_lazy_junio_2, R.drawable.book_lazy_junio_3, R.drawable.book_lazy_junio_4, R.drawable.book_lazy_junio_5, R.drawable.book_lazy_junio_6, R.drawable.book_lazy_junio_7, R.drawable.book_lazy_junio_8,
                    R.drawable.book_lazy_junio_9, R.drawable.book_lazy_junio_10, R.drawable.book_lazy_junio_11, R.drawable.book_lazy_junio_12, R.drawable.book_lazy_junio_13, R.drawable.book_lazy_junio_14, R.drawable.book_lazy_junio_15, R.drawable.book_lazy_junio_16,
                    R.drawable.book_lazy_junio_17).setIconRes(R.drawable.book_lazy_junio_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_manga_cows_1, R.drawable.book_manga_cows_2, R.drawable.book_manga_cows_3, R.drawable.book_manga_cows_4, R.drawable.book_manga_cows_5, R.drawable.book_manga_cows_6, R.drawable.book_manga_cows_7, R.drawable.book_manga_cows_8,
                    R.drawable.book_manga_cows_9, R.drawable.book_manga_cows_10, R.drawable.book_manga_cows_11, R.drawable.book_manga_cows_12, R.drawable.book_manga_cows_13, R.drawable.book_manga_cows_14,
                    R.drawable.book_manga_cows_15, R.drawable.book_manga_cows_16, R.drawable.book_manga_cows_17, R.drawable.book_manga_cows_18, R.drawable.book_manga_cows_19, R.drawable.book_manga_cows_20,
                    R.drawable.book_manga_cows_21, R.drawable.book_manga_cows_22).setIconRes(R.drawable.book_manga_and_cows_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_monkey_eats_tail_1, R.drawable.book_monkey_eats_tail_2, R.drawable.book_monkey_eats_tail_3, R.drawable.book_monkey_eats_tail_4, R.drawable.book_monkey_eats_tail_5, R.drawable.book_monkey_eats_tail_6, R.drawable.book_monkey_eats_tail_7,
                    R.drawable.book_monkey_eats_tail_8, R.drawable.book_monkey_eats_tail_9, R.drawable.book_monkey_eats_tail_10, R.drawable.book_monkey_eats_tail_11, R.drawable.book_monkey_eats_tail_12, R.drawable.book_monkey_eats_tail_13, R.drawable.book_monkey_eats_tail_14,
                    R.drawable.book_monkey_eats_tail_15,R.drawable.book_monkey_eats_tail_16, R.drawable.book_monkey_eats_tail_17, R.drawable.book_monkey_eats_tail_18, R.drawable.book_monkey_eats_tail_19, R.drawable.book_monkey_eats_tail_20,
                    R.drawable.book_monkey_eats_tail_21, R.drawable.book_monkey_eats_tail_22, R.drawable.book_monkey_eats_tail_23, R.drawable.book_monkey_eats_tail_24, R.drawable.book_monkey_eats_tail_25, R.drawable.book_monkey_eats_tail_26,
                    R.drawable.book_monkey_eats_tail_27, R.drawable.book_monkey_eats_tail_28).setIconRes(R.drawable.book_monkey_eats_tail_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_musty_monster_1, R.drawable.book_musty_monster_2, R.drawable.book_musty_monster_3, R.drawable.book_musty_monster_4, R.drawable.book_musty_monster_5, R.drawable.book_musty_monster_6, R.drawable.book_musty_monster_7,R.drawable.book_musty_monster_8,
                    R.drawable.book_musty_monster_9, R.drawable.book_musty_monster_10, R.drawable.book_musty_monster_11, R.drawable.book_musty_monster_12, R.drawable.book_musty_monster_13, R.drawable.book_musty_monster_14, R.drawable.book_musty_monster_15, R.drawable.book_musty_monster_16,
                    R.drawable.book_musty_monster_17, R.drawable.book_musty_monster_18, R.drawable.book_musty_monster_19, R.drawable.book_musty_monster_20, R.drawable.book_musty_monster_21, R.drawable.book_musty_monster_22, R.drawable.book_musty_monster_23,
                    R.drawable.book_musty_monster_24, R.drawable.book_musty_monster_25, R.drawable.book_musty_monster_26, R.drawable.book_musty_monster_27, R.drawable.book_musty_monster_28, R.drawable.book_musty_monster_29).setIconRes(R.drawable.book_musty_monster_icon).setRealSupport(true));
            list.add(new Book(R.drawable.my_family_reads_1, R.drawable.my_family_reads_2,R.drawable.my_family_reads_3, R.drawable.my_family_reads_4, R.drawable.my_family_reads_5, R.drawable.my_family_reads_6, R.drawable.my_family_reads_7, R.drawable.my_family_reads_8, R.drawable.my_family_reads_9,
                    R.drawable.my_family_reads_10, R.drawable.my_family_reads_11, R.drawable.my_family_reads_12, R.drawable.my_family_reads_13).setIconRes(R.drawable.book_my_family_reads_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_papa_snake_1, R.drawable.book_papa_snake_2, R.drawable.book_papa_snake_3, R.drawable.book_papa_snake_4, R.drawable.book_papa_snake_5, R.drawable.book_papa_snake_6, R.drawable.book_papa_snake_7, R.drawable.book_papa_snake_8, R.drawable.book_papa_snake_9,
                    R.drawable.book_papa_snake_10, R.drawable.book_papa_snake_11, R.drawable.book_papa_snake_12, R.drawable.book_papa_snake_13, R.drawable.book_papa_snake_14, R.drawable.book_papa_snake_15, R.drawable.book_papa_snake_16, R.drawable.book_papa_snake_17, R.drawable.book_papa_snake_18,
                    R.drawable.book_papa_snake_19, R.drawable.book_papa_snake_20).setRealSupport(true).setIconRes(R.drawable.book_papa_snake_icon));
            list.add(new Book(R.drawable.book_rabbit_under_tree_1, R.drawable.book_rabbit_under_tree_2, R.drawable.book_rabbit_under_tree_3, R.drawable.book_rabbit_under_tree_4, R.drawable.book_rabbit_under_tree_5, R.drawable.book_rabbit_under_tree_6, R.drawable.book_rabbit_under_tree_7, R.drawable.book_rabbit_under_tree_8,
                    R.drawable.book_rabbit_under_tree_9, R.drawable.book_rabbit_under_tree_10, R.drawable.book_rabbit_under_tree_11, R.drawable.book_rabbit_under_tree_12, R.drawable.book_rabbit_under_tree_13, R.drawable.book_rabbit_under_tree_14, R.drawable.book_rabbit_under_tree_15, R.drawable.book_rabbit_under_tree_16,
                    R.drawable.book_rabbit_under_tree_17, R.drawable.book_rabbit_under_tree_18, R.drawable.book_rabbit_under_tree_19, R.drawable.book_rabbit_under_tree_20, R.drawable.book_rabbit_under_tree_21, R.drawable.book_rabbit_under_tree_22, R.drawable.book_rabbit_under_tree_23, R.drawable.book_rabbit_under_tree_24,
                    R.drawable.book_rabbit_under_tree_25, R.drawable.book_rabbit_under_tree_26, R.drawable.book_rabbit_under_tree_27, R.drawable.book_rabbit_under_tree_28, R.drawable.book_rabbit_under_tree_29, R.drawable.book_rabbit_under_tree_30, R.drawable.book_rabbit_under_tree_31,
                    R.drawable.book_rabbit_under_tree_32, R.drawable.book_rabbit_under_tree_33, R.drawable.book_rabbit_under_tree_34, R.drawable.book_rabbit_under_tree_35, R.drawable.book_rabbit_under_tree_36).setIconRes(R.drawable.book_rabbit_under_tree_icon).setRealSupport(true));
            list.add(new Book(R.drawable.book_rainbow_village_1, R.drawable.book_rainbow_village_2, R.drawable.book_rainbow_village_3, R.drawable.book_rainbow_village_4, R.drawable.book_rainbow_village_5, R.drawable.book_rainbow_village_6, R.drawable.book_rainbow_village_7, R.drawable.book_rainbow_village_8, R.drawable.book_rainbow_village_9,
                    R.drawable.book_rainbow_village_10, R.drawable.book_rainbow_village_11, R.drawable.book_rainbow_village_12, R.drawable.book_rainbow_village_13, R.drawable.book_rainbow_village_14, R.drawable.book_rainbow_village_15, R.drawable.book_rainbow_village_16, R.drawable.book_rainbow_village_17, R.drawable.book_rainbow_village_18,
                    R.drawable.book_rainbow_village_19, R.drawable.book_rainbow_village_20, R.drawable.book_rainbow_village_21, R.drawable.book_rainbow_village_22, R.drawable.book_rainbow_village_23, R.drawable.book_rainbow_village_24, R.drawable.book_rainbow_village_25, R.drawable.book_rainbow_village_26, R.drawable.book_rainbow_village_27).setRealSupport(true)
            .setIconRes(R.drawable.book_rainbow_village_icon));
            list.add(new Book(R.drawable.book_sani_lies_2, R.drawable.book_sani_lies_3, R.drawable.book_sani_lies_4, R.drawable.book_sani_lies_5, R.drawable.book_sani_lies_6, R.drawable.book_sani_lies_7, R.drawable.book_sani_lies_8, R.drawable.book_sani_lies_9, R.drawable.book_sani_lies_10, R.drawable.book_sani_lies_11, R.drawable.book_sani_lies_12,
                    R.drawable.book_sani_lies_13, R.drawable.book_sani_lies_14, R.drawable.book_sani_lies_15, R.drawable.book_sani_lies_16, R.drawable.book_sani_lies_17, R.drawable.book_sani_lies_18, R.drawable.book_sani_lies_20, R.drawable.book_sani_lies_21, R.drawable.book_sani_lies_22, R.drawable.book_sani_lies_23, R.drawable.book_sani_lies_24, R.drawable.book_sani_lies_25
            , R.drawable.white)
            .setIconRes(R.drawable.book_sani_lies_icon).setRealSupport(true));

            list.add(new Book(R.drawable.book_snail_hermit_1, R.drawable.book_snail_hermit_2, R.drawable.book_snail_hermit_3, R.drawable.book_snail_hermit_4, R.drawable.book_snail_hermit_5, R.drawable.book_snail_hermit_6, R.drawable.book_snail_hermit_7, R.drawable.book_snail_hermit_8, R.drawable.book_snail_hermit_9, R.drawable.book_snail_hermit_10,
                    R.drawable.book_snail_hermit_11, R.drawable.book_snail_hermit_12, R.drawable.book_snail_hermit_13, R.drawable.book_snail_hermit_14, R.drawable.book_snail_hermit_15, R.drawable.book_snail_hermit_16, R.drawable.book_snail_hermit_17, R.drawable.book_snail_hermit_18, R.drawable.book_snail_hermit_19, R.drawable.book_snail_hermit_20,
                    R.drawable.book_snail_hermit_21, R.drawable.book_snail_hermit_22, R.drawable.book_snail_hermit_23, R.drawable.book_snail_hermit_24, R.drawable.book_snail_hermit_25).setIconRes(R.drawable.book_sani_lies_icon).setRealSupport(true));

            list.add(new Book(R.drawable.book_sun_up_1, R.drawable.book_sun_up_2, R.drawable.book_sun_up_3, R.drawable.book_sun_up_4, R.drawable.book_sun_up_5, R.drawable.book_sun_up_6, R.drawable.book_sun_up_7, R.drawable.book_sun_up_8, R.drawable.book_sun_up_9, R.drawable.book_sun_up_10, R.drawable.book_sun_up_11, R.drawable.book_sun_up_12,
                    R.drawable.book_sun_up_13, R.drawable.book_sun_up_14, R.drawable.book_sun_up_15, R.drawable.book_sun_up_16, R.drawable.book_sun_up_17, R.drawable.book_sun_up_18, R.drawable.book_sun_up_19, R.drawable.book_sun_up_20, R.drawable.book_sun_up_21,
                    R.drawable.book_sun_up_23, R.drawable.book_sun_up_22, R.drawable.book_sun_up_24, R.drawable.book_sun_up_25, R.drawable.book_sun_up_26, R.drawable.book_sun_up_27, R.drawable.book_sun_up_28, R.drawable.book_sun_up_29, R.drawable.book_sun_up_30, R.drawable.white)
            .setIconRes(R.drawable.book_sun_up_icon).setRealSupport(true));

            list.add(new Book(R.drawable.book_where_is_cat_1, R.drawable.book_where_is_cat_2, R.drawable.book_where_is_cat_3, R.drawable.book_where_is_cat_4, R.drawable.book_where_is_cat_5, R.drawable.book_where_is_cat_6, R.drawable.book_where_is_cat_7, R.drawable.book_where_is_cat_8, R.drawable.book_where_is_cat_9, R.drawable.book_where_is_cat_10,
                    R.drawable.book_where_is_cat_11, R.drawable.book_where_is_cat_12, R.drawable.white).setIconRes(R.drawable.book_where_is_cat_icon).setRealSupport(true));

            list.add(new Book(R.drawable.book_who_sank_boat_1, R.drawable.book_who_sank_boat_2, R.drawable.book_who_sank_boat_3, R.drawable.book_who_sank_boat_4, R.drawable.book_who_sank_boat_5, R.drawable.book_who_sank_boat_6, R.drawable.book_who_sank_boat_7, R.drawable.book_who_sank_boat_8, R.drawable.book_who_sank_boat_9, R.drawable.book_who_sank_boat_10, R.drawable.book_who_sank_boat_11,
                    R.drawable.book_who_sank_boat_12, R.drawable.book_who_sank_boat_13, R.drawable.book_who_sank_boat_14, R.drawable.book_who_sank_boat_15, R.drawable.book_who_sank_boat_16, R.drawable.book_who_sank_boat_17, R.drawable.book_who_sank_boat_18, R.drawable.white).setIconRes(R.drawable.book_who_sank_boat_icon).setRealSupport(true));
            return list;
        }
