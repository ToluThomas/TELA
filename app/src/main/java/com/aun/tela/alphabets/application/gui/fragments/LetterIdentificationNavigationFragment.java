 ...
 */
public class LetterIdentificationNavigationFragment extends Fragtivity {
    ...
    public LetterIdentificationNavigationFragment setBackCollector(Collector backCollector){
        this.backCollector = backCollector; return this;
    }

    public LetterIdentificationNavigationFragment setTextColor(int textColor){
        this.textColor = textColor; return this;
    }

    public LetterIdentificationNavigationFragment setBorderColor(int borderColor){
    ...
    void addHeader(int color, int borderColor){
        ...
        i.setImageResource(R.drawable.letter_identification_bevel);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public static ViewHolder inflateDefault(ViewGroup parent){
            return new ViewHolder(LayoutInflater.from(Activity.getInstance()).inflate(R.layout.grid_item_easter_egg_text, parent, false));
        }
        ...
        public static ViewHolder setup(ViewHolder viewHolder, String string, Integer position, Boolean isLast){
            ...
            int cs = Math.abs(((position+4)%3)-3);
            switch (cs){
                case 1:
                    viewHolder.image.setImageResource(R.drawable.egg_green);
                    break;
                case 2:
                    viewHolder.image.setImageResource(R.drawable.egg_red);
                    break;
                case 3:
                    viewHolder.image.setImageResource(R.drawable.egg_blue);
                    break;
            }
            return viewHolder;
        }
