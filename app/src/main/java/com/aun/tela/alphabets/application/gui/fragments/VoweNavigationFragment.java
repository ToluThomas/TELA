 ...
 */
public class VoweNavigationFragment extends Fragtivity {
    ...
    public static VoweNavigationFragment getInstance(int textColor, int borderColor){
        return new VoweNavigationFragment().setColors(textColor, borderColor);
    }

    public VoweNavigationFragment setColors(int textColor, int borderColor){
        this.textColor = textColor; this.borderColor = borderColor; return this;
    }

    @Override
    public int layoutId() {
        return R.layout.fragment_navigation_vowels;
    }
    ...
    public void findViews() {
        ...
        headerBar = (BarColorView) findViewById(R.id.headerBar);
    }
    ...
    public void setupViews() {
        ...
        headerBar.setBarColor(textColor);
    ...
    void select(View v){
        ...
        ValueAnimator animator = ObjectAnimator.ofPropertyValuesHolder(arialTextView, x, y, ts);
    ...
    void switchToAnimation(String consonant, Collector collector){
        ...
        //this.animationFragment = VowelAnimationFragment.getInstance(textColor, borderColor, Factory.Alphabets.Consonant.build(consonant));
    ...
    void resetAdapter(){
        List<String> consonants = Factory.Alphabets.copyVowels();
        consonants.add(0, "");
        consonants.add(0, "");
